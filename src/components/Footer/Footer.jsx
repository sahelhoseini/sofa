    ...
    <>
      <div className="w-full max-w-[1440px] m-auto bg-gray-950 grid grid-cols-4 gap-2 py-10 px-5 md:px-20 mt-10">
        <div className="col-span-2 md:col-span-1 px-5">
          <p className="text-lg text-white mb-2">Our Store</p>
        ...
        <div className="col-span-2 md:col-span-1 px-5">
          <p className="text-lg text-white mb-2">Quick Links</p>
        ...
        <div className="col-span-2 md:col-span-1 px-5">
          <p className="text-lg text-white mb-2">Information</p>
          <ul>
        ...
        <div className="col-span-2 md:col-span-1 px-5">
          <p className="text-lg text-white mb-2">Let's Get In Touch</p>
          <p className="text-gray-500">
